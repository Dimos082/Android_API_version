...
public class AndroidAPIversion
{
    public static void main(String[] args) {
		...
		} else if (userInput.equals("2.0") || userInput.equals("5")) {
			System.out.println("Eclair	2.0	API level 5");	
		} else if (userInput.equals("2.0.1") || userInput.equals("6")) {
			System.out.println("Eclair	2.0.1	API level 6");
		} else if (userInput.equals("2.1") || userInput.equals("7")) {
		...
		} else if (userInput.equals("2.3") || userInput.equals("9")) {
			System.out.println("Gingerbread	2.3 - 2.3.2	API level 9, NDK 5");
		} else if (userInput.equals("2.3.7") || userInput.equals("10")) {
		...
		} else if (userInput.equals("3.0") || userInput.equals("11")) {
			System.out.println("Honeycomb	3.0	API level 11");
		} else if (userInput.equals("3.1") || userInput.equals("12")) {
			System.out.println("Honeycomb	3.1	API level 12, NDK 6");
		} else if (userInput.equals("3.2") || userInput.equals("13")) {
		...
		} else if (userInput.equals("4.0.1") || userInput.equals("14")) {
			System.out.println("Ice Cream Sandwich	4.0.1 - 4.0.2	API level 14, NDK 7");
		} else if (userInput.equals("4.0.3") || userInput.equals("15")) {
		...
		} else if (userInput.equals("4.1") || userInput.equals("16")) {
			System.out.println("Jelly Bean	4.1.x	API level 16");
		} else if (userInput.equals("4.2") || userInput.equals("17")) {
			System.out.println("Jelly Bean	4.2.x	API level 17");
		} else if (userInput.equals("4.3") || userInput.equals("18")) {
		...
		} else if (userInput.equals("5.0") || userInput.equals("21")) {
			System.out.println("Lollipop	5.0	API level 21");
		} else if (userInput.equals("5.1") || userInput.equals("22")) {
			System.out.println("Lollipop	5.1	API level 22");
		} else if (userInput.equalsIgnoreCase("Lollipop")) {          //for one string output
			System.out.println("Lollipop	5.0-5.1	API level 21,22");
		...
		} else if (userInput.equals("7") || userInput.equals("24")) {
			System.out.println("Nougat	7.0	API level 24");
		} else if (userInput.equals("7.1") || userInput.equals("25")) {
			System.out.println("Nougat	7.1	API level 25");
		} else if (userInput.equalsIgnoreCase("Nougat")) {          //for one string output
			System.out.println("Nougat	7.0-7.1	API level 24,25");
		} else if (userInput.equals("8.0") || userInput.equals("26")) {
			System.out.println("Oreo	8.0.0	API level 26");
		} else if (userInput.equals("8.1") || userInput.equals("27")) {
			System.out.println("Oreo	8.1.0	API level 27");
		} else if (userInput.equalsIgnoreCase("Oreo")) {          //for one string output
			System.out.println("Oreo	8.0.0-8.1.0	API level 26-27");
		...
		} else { System.out.println("Can't find " + "'" + userInput + "'" + " :-(");          //If userInput returned something besides options above
